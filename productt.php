							...
							<ul class="top_nav_menu">
								...
								<li class="account">
									...
									<ul class="account_selection">
										...
										<li><a href="signup.php"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
									</ul>
								</li>
							</ul>
						</div>
		...
		<div class="row">
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="index.php">Home</a></li>
						<li><a href="shopp.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Shop</a></li>
		...
		<div class="row">
			...
			<div class="col-lg-5">
                ...
                while ($sizeRow = $result->fetch_assoc()) {
                    ?>
							<li>
							<input type="radio" name="selected_size" value="<?php echo $sizeRow['size']; ?>"> 
